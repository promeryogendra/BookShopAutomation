	...
	<body>
		...
		<div class="topnav">
			...
			<div class="search-container">
				<form action="searchbook" method="post">
					<input type="text"  required placeholder="Search.." name="search" autocomplete="off" list="browsers" >
					<datalist id="browsers">
					<% customermethods c=new customermethods();
						List<String> suggest=c.getsuggesions();
						Iterator<String> itr=suggest.iterator();
						int l=0;
						while(itr.hasNext())
						{
							l=1;%>
							<option value="<%=itr.next()%>">
							<%
						}
		...
		<div>
			...
			<%
				...
				%>
			<div class="profile">
				<h1 class="prohead">PROFILE</h1>
				<div class="data">
					<h2><pre>NAME   :   <%=name%></pre></h2>
					<h2><pre>USERID :   <%=userid%></pre></h2>
					<h2><pre>GMAIL  :   <%=gmail%></pre></h2>
					<h2><pre>PHONE  :   <%=phoneno%></pre></h2>
