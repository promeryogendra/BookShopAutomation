...
.status:hover {
	...
	<body>
		...
		<div style="padding-left:16px">
			<div class="hea">
				<h1 style="color:green;padding-top:90px;">BOOK WITH GIVEN ISBN IS SUCCESSFULLY REMOVED FROM BOOKSTORE.<br>
					UPDATE OR ADD MORE BOOKS FOR CUSTOMERS.<br/>
				</h1>
			</div>
			<form action="clerkremovebook.jsp" method="post">
