	...
	<body>
		...
		<div class="divi">
			<form action="adminupdatebook" method="post">
				<label style="font-size:25px;">ISBN&emsp;&emsp;</label>
				<input required id="username" type="text" value="ISBN" pattern="[I]{1}[S]{1}[B]{1}[N]{1}[0-9]{9}" name="isbn" placeholder="ISBN">(required)
				<br/><br/><br>
				<label style="font-size:25px;">UPDATE</label>
				&nbsp;&nbsp;&nbsp;<label class="radioc">COST&nbsp;
					<input type="radio" name="optradio" value="bcost">
					<span class="circle"></span>
				</label>
				<label class="radioc">COUNT
					<input type="radio" name="optradio" value="bcount">
					<span class="circle"></span>
				</label><br/><br/>
				<label style="font-size:25px;">&nbsp;Value&emsp;&nbsp;&nbsp;</label>
					<input required id="password" type="text" name="value" placeholder="Enter value to update" pattern="[1-9]{1}[0-9]{0,20}" onkeypress="return AllowNumbersOnly(event)">(required)
					<br/><br/>
				<input style="margin-left:180px;" class="isbnsubmit" type="submit" value="Submit">
