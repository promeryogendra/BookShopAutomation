...
.catbox:hover img{
	...
	<body>
		...
		<div style="padding-left:16px">
			<div class="hea">
				<h1 style="color:green;padding-top:90px;">SORRY THE BOOK WITH GIVEN ISBN NOT UPDATED.<br>
					DUE SOME DATABASE MANAGEMENT PROBLEM.<br>PLEASE TRY AFTER SOME TIME.<br/>
				</h1>
			</div>
		</div>
	</body>
